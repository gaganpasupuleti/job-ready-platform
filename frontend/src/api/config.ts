...
export const apiEndpoints = {
  ...
  learn: {
    ...
    studioCatalog: '/api/v1/studio/catalog',
    studioMaterial: (key: string) => `/api/v1/studio/materials/${key}`,
    studioMaterialRead: (key: string) => `/api/v1/studio/materials/${key}/read`,
    studioMaterialDownload: (key: string) => `/api/v1/studio/materials/${key}/download`,
    studioAssignment: (key: string) => `/api/v1/studio/assignments/${key}`,
